 ...
 *       &lt;sequence&gt;
 *         &lt;element name="faultType" type="{http://crv.soacourse.unsw.edu.au}CRVCheckFaultType"/&gt;
...
@XmlRootElement(name = "CRVCheckFault")
public class CRVCheckFault {

    @XmlElement(required = true)
    @XmlSchemaType(name = "string")
    protected CRVCheckFaultType faultType;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link CRVCheckFaultType }
     *     
     */
    public CRVCheckFaultType getFaultType() {
        return faultType;
    }
     ...
     *     
     */
    public void setFaultType(CRVCheckFaultType value) {
